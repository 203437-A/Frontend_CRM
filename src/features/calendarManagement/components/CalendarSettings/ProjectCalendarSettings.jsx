...
const ProjectCalendarSettings = ({ isOpen, closeModal }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.put('/project-calendar-settings/', settings);
...
export default ProjectCalendarSettings;
